    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1>Calendrier</h1>
                <a href="reservationAdmin.php" class="fa fa-arrow-circle-left" style="text-center:left"> Back</a>
            ...
            <a href="reservationAdmin.php" class="fa fa-arrow-circle-left"> Back</a>
