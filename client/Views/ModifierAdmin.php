...
if (isset($_POST['modifier']))
{
    ...
    if (isset($_POST['pseudo']) AND isset($_POST['id']) AND isset($_POST['mail']) AND $_POST['motdepasse1']==$_POST['motdepasse2']) {
     $id=$_POST['id'];
 $pseudo=$_POST['pseudo'];
    $mail=$_POST['mail'];
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Forms <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="reclamationA.php">Réservations</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <ul class="row">
                                               <li class="col-sm-12">
                                                    <label>
                          <input type="text" class="form-control" name="id" id="name" placeholder="*id">
                        </label>
                                                </li>
                                                <li class="col-sm-12">
                                                    <label>
