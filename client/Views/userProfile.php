...
<body>
    ...
    <div id="wrap">
        ...
        <div class="content">
            ...
            <div class="hover-port">
                <div class="position-center-center"> <a href=""></a> <a href="#."></i></a>
                </div>
            </div>
            </article>
            </li>
    ...
    <!--======= content gdim =========-->
<div style="background-color: #201B22">
    <!--======== profile content =======-->
...
<div class="container">
  <div class="mySlides">
    ...
    <img src="http://hdqwalls.com/wallpapers/amanda-cerny-th.jpg" style="width:100%">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 6</div>
    <img src="https://i.ytimg.com/vi/R-knw5ISYUE/maxresdefault.jpg" style="width:100%">
  </div>
  ...
  <div class="mySlides">
    ...
    <img src="https://assets.wetheunicorns.com/2018/06/amanda-cerny-1518433353-list-handheld-0.jpg" style="width:100%">
  </div>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="https://www.thefamouspeople.com/profiles/images/amanda-cerny-1.jpg" style="width:100%" onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="https://www.famousbirthdays.com/headshots/amanda-cerny-1.jpg" style="width:100%" onclick="currentSlide(2)" alt="Trolltunga, Norway">
    </div>
    <div class="column">
      <img class="demo cursor" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTE4Ut_ou0ksYwVoPPJ4AsHohe6QgjKyr6i6S5GqB8KowYb0xZz" style="width:100%" onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
    <div class="column">
