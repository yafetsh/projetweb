	         ...
	         if (!empty($_POST['mail'])) {
	        	...
	        	$mail = $_POST['mail'];
	             ...
	             if(filter_var($mail,FILTER_VALIDATE_EMAIL)){
                    ...
                    $mailexist = $utilisateur1C->VerifierEmail($mail);
                                if ($mailexist == 1) {
                                	$NewsLetterexist = $utilisateur1C->VerifierNewsletter($mail);
                                	if ($NewsLetterexist == 0) {
                                		$utilisateur1C->AjouterNewsletter($mail);
                                		$erreur="votre email à été bien ajouté au Newsletter de FashionMakeup";
                                	}else{
                                		$erreur = "vous etes déja inscrit au Newsletter de FashionMakeup !";
                                	}
                                } else{
                                	$erreur ="veuillez vous inscrire à FashionMakeup d'abord !";
                                }
	             }else {
                     $erreur ="Veuillez s'il vous plait entrer une adresse email valide !";
	             }
	         } else {
	         	$erreur="Veuillez s'il vous plait taper votre email ";
	         }
    }
...
<title>Newsletter-Fashionmakeup</title>
<!--[if IE]>
...
<div class="arw-mobile-menu">
    ...
    <div class="sidebar-menu">
        <ul id="arw_accordionmenu_2140358698" class="nav-accordion nav-mobile-accordion">
...
</li><li class="child-2-cols level1 item classic nav-4-3 last parent">
...
</li><li class=" level0 nav-6 level-top m-dropdown menu-style-dropdown last parent">
...
<span>Hair</span>
        ...
        <script type="text/javascript">
            jQuery(document).ready(function() {
                jQuery("#arw_accordionmenu_2140358698").arwAccordionMenu({
                    accordion:true,
                    speed: 400,
                    closedSign: 'collapse',
                    openedSign: 'expand',
...
<div class="site-overlay"></div>
    <script type="text/javascript">
        //<![CDATA[
        var ajaxCartObj = new ajaxCart({"send_url":"http:\/\/sebian.demo.arw.tf\/cosmetic\/ajaxcart\/ajax\/index\/","update_url":"http:\/\/sebian.demo.arw.tf\/cosmetic\/checkout\/cart\/updatePost\/","src_image_progress":"http:\/\/sebian.demo.arw.tf\/skin\/frontend\/arw_sebian\/default\/images\/loading.gif","error":" \u2191 This is a required field.","is_product_view":0});
        //]]>
    </script>
<script type="text/javascript">
//<![CDATA[
document.observe("dom:loaded", function() {
	var Slide=new tabSlide({"url":"http:\/\/sebian.demo.arw.tf\/cosmetic\/producttab\/producttab\/product\/","effect":"slide","duration":"1","from":"0","to":"100","direction":"true","identifier":null,"icon":"http:\/\/sebian.demo.arw.tf\/media\/arw\/producttab\/ajax\/ajax-loader.gif","is_product_view_tab":0});
	Slide.run();
});
//]]
                ...
                <nav class="nav-primary-container clearfix">
                    <div class="wrap-nav">
                        ...
                        <div class="sticky-logo">
                            <a href="http://sebian.demo.arw.tf/cosmetic/" title="Magento Commerce"><img src="http://sebian.demo.arw.tf/skin/frontend/arw_sebian/default/images/media/logo.png" alt="Magento Commerce" /></a>
                        </div>
...
<div class="arw-mobile-menu">
    ...
    <div class="sidebar-menu">
        <ul id="arw_accordionmenu_1045298024" class="nav-accordion nav-mobile-accordion">
            <li><a href="http://sebian.demo.arw.tf/cosmetic/"><span>Home</span></a></li>
            <li class=" level0 nav-4 level-top first menu-style-group parent">
<a href="http://sebian.demo.arw.tf/cosmetic/make-up.html" class="level-top">
<span>Make Up</span>
...
<span>Hair</span>
        ...
        <script type="text/javascript">
            jQuery(document).ready(function() {
                jQuery("#arw_accordionmenu_1045298024").arwAccordionMenu({
                    accordion:true,
                    speed: 400,
                    closedSign: 'collapse',
                    openedSign: 'expand',
...
<div class="site-overlay"></div>
    ...
    <h1>S'ABONNER AU NEWSLETTER</h1>
</div>
<form  method="post" id="form-validate">
    <div class="fieldset">
        <h2 class="legend">Abonnez-vous à la newsletter et recevez toutes les offres et nouveautés.</h2>
        <p>Abonnez-vous à notre newsletter en remplissant le formulaire ci-dessous. Votre adresse de messagerie est uniquement utilisée pour vous envoyer notre lettre d'actualité ainsi que des informations...
</p>
        <ul class="form-list">
            <li>
                <label for="email_address" class="required"><em>*</em>Adresse Email</label>
                <div class="input-box">
                    <input type="text" name="mail" alt="email" id="email_address" class="input-text required-entry validate-email" value="" />
                    <?php 
                        if (isset($erreur)) {
                        	echo $erreur;
                        }
    ...
    <div class="buttons-set">
        <p class="required">* Votre adresse de messagerie est uniquement utilisée pour vous envoyer notre lettre d'actualité </p>
        <p class="back-link"><a href="http://sebian.demo.arw.tf/cosmetic/customer/account/login/"><small>&laquo; </small>Retour à l'acceuil</a></p>
...
//]]>
	...
	<div class="widget widget-static-block"><div class="arw_sebian_block_footer_top">
	<div class="container">
		<div class="row">
	...
	<div class="block-content">
		<ul>
			...
			<div class="arw-col col-xs-6 col-sm-6 col-md-3 col-lg-3">
				<div class="widget widget-static-block"><div class="block block-custom-flickr-photo">
	<div class="block-title">
