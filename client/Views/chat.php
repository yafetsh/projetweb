...
if (isset($_POST['message']) AND !empty($_POST['message'])) {
  $_SESSION['pseudo'] =  $_SESSION['pseudo'];
    ...
    $utilisateur2C->chat($_SESSION['pseudo'],$message);
  }
} else {
...
<div id="wrap">
  ...
  <section class="sub-banner animate fadeInUp" data-wow-delay="0.4s">
    <div class="container">
      <h4>LIVE CHAT(<?php echo $user_nbr; ?>)en Ligne</h4>
      <!-- Breadcrumb -->
      <ol class="breadcrumb">
  ...
  <input type="text" class="form-control" placeholder="PSEUDO" name="pseudo" value="<?php echo $_SESSION['pseudo']?>" disabled> <br> <br>
  <textarea type="text" class="form-control" placeholder="MESSAGE" name="message"></textarea> <br> 
