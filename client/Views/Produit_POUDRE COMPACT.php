            ...
            <section class="sub-banner animate fadeInUp" data-wow-delay="0.4s">
                <div class="container">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">POUDRE COMPACT</li>
                    </ol>
                </div>
            </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 animate fadeInUp" data-wow-delay="0.2s">
                            ...
                            <div class="popurlar_product">
                                <h1 style="font-weight: normal; color: #333333; font-family: 'Montserrat', sans-serif; font-size: 24px ">Consulter Nos Produits<br> <small>POUDRE COMPACT</small> </h1>
                                <br>
                                <ul class="row">
                                    <!--NOUVEAU-->
                                    <!-- New Products -->
                                   <?php
                                        foreach ($listeproduit as $key => $value) {
                                            if($value['nomCatalogue']=="POUDRE COMPACT"){
                                    ?>
