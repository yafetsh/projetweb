        ...
        <div class="tittle">
		 ...
		 <div class="contact section-p-30px no-padding-b">
          <div class="contact-form">
		    <!--======= FORM  =========-->
            <form role="form" id="contact_form" class="contact-form" method="POST" action="modifierlivraison.php?id=<?php echo $id?>">
                <div class="row">
                  <div class="col-md-6">
                    <ul class="row">
                      <li class="col-sm-12">
                      ...
                      <li class="col-sm-12">
                        <label> Rue:*
                          <input type="text" class="form-control" name="rue" value="<?php echo !empty($rue)?$rue:'';?>" >
                        </label>
                      </li>
                      <li class="col-sm-12">
                        <label> Numéro téléphone:*
                          <input type="text" class="form-control" name="numero" value="<?php echo !empty($numero)?$numero:'';?>">                        </label>
                      </li>
                    </ul>
                  </div>
                  <div class="col-md-6">
                ...
                <option value="6">Zaghouan</option></select></label>  </li>


                      <li class="col-sm-12">
                        <label>Ville:*
                          <input type="text" class="form-control" name="ville" value="<?php echo !empty($ville)?$ville:'';?>" >
                        </label>
  </li>
