...
<div id="wrap">
    ...
    <div class="content">
        ...
        <section class="sub-banner animate fadeInUp" data-wow-delay="0.4s">
            ...
            <div class="container">
                <form method="POST" action="ModifierCommandephp.php">
                    <table width="90%">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                $idscom=$com->idscommande($_GET['id']);
                                foreach ($idscom as $idcom) { ?>
                                <input type="hidden" name="id" value="<?php echo $idcom["id"];?>">
                                        <?php
                                    }
                                    ?>
                            </td>
                        ...
                        <tr>
                            <td>quantite</td>
                            <td> <input type="number" name="quantite" value="<?php echo $idcom["quantite"];?>"></td>
                        </tr>

                        <tr>
                            <td>
                                    <?php foreach ($produits as $pro) { ?>
                                        <input type="hidden" name="idpanier" value="<?php echo $pro->id;?>">
                                        <?php
                                    }
                                    ?>
                            </td>
