      ...
      <div class="container">
        <div class="row"> 
          ...
          <div class="col-sm-6 animate fadeInleft" data-wow-delay="0.4s"> 
            ...
            <div class="tittle">
              <h5>GET IN TOUCH</h5>
              <p>Please don’t hesitate to contact me if you have any questions, commnets or messages. I’ll try to respond to everything! </p>
            </div>
            <div class="contact">
        ...
        <div class="row animate fadeInUp" data-wow-delay="0.4s"> 
          ...
          <div class="col-md-6">
            <ul class="row">
              ...
              <li class="col-sm-4"> 
                <!--  Image --> 
                <img class="img-responsive" src="images/avatar-con-1.jpg" alt=""> 
                <!--  Details -->
                <h5>M_Adnan</h5>
                <p>Support Manager</p>
                <span><i class="fa fa-skype"></i> adnan.arif69</span> </li>
              <!-- SUPPORT PEOPLE -->
              <li class="col-sm-4"> 
                <!--  Image --> 
                <img class="img-responsive" src="images/avatar-con-2.jpg" alt=""> 
                <!--  Details -->
                <h5>LADY SANSA</h5>
                <p>Support Manager</p>
                <span><i class="fa fa-skype"></i> adnan.arif69</span> </li>
              ...
              <li class="col-sm-4"> 
                <!--  Image --> 
                <img class="img-responsive" src="images/avatar-con-3.jpg" alt=""> 
                <!--  Details -->
                <h5>MARRY DOE</h5>
                <p>Support Manager</p>
                <span><i class="fa fa-skype"></i> adnan.arif69</span> </li>
          ...
          <div class="col-md-6">
            <ul class="row">
              ...
              <li class="col-sm-4"> 
                <!--  Image --> 
                <img class="img-responsive" src="images/avatar-con-4.jpg" alt=""> 
                <!--  Details -->
                <h5>DAVID STARK</h5>
                <p>Support Manager</p>
                <span><i class="fa fa-skype"></i> adnan.arif69</span> </li>
              ...
              <li class="col-sm-4"> 
                <!--  Image --> 
                <img class="img-responsive" src="images/avatar-con-5.jpg" alt=""> 
                <!--  Details -->
                <h5>PETER DOE</h5>
                <p>Support Manager</p>
                <span><i class="fa fa-skype"></i> adnan.arif69</span> </li>
              ...
              <li class="col-sm-4"> 
                <!--  Image --> 
                <img class="img-responsive" src="images/avatar-con-6.jpg" alt=""> 
                <!--  Details -->
                <h5>JOHNNY DEEP</h5>
                <p>Support Manager</p>
                <span><i class="fa fa-skype"></i> adnan.arif69</span> </li>
...
if ($('#map').length) {
	var myLatLng = new google.maps.LatLng(36.8346589,10.2426542);
	var mapOptions = {
		zoom: 12,
		center: myLatLng,
		scrollwheel: false,
